Ext.define("ArenaFight.view.screens.FightScreenController", {
  extend: "Ext.app.ViewController",
  alias: "controller.fightscreen",
  ...
  fightOpponent: function (name, strength, stamina, intellect, agility, opponentImage) {
    ...
    setTimeout(() => {
      ...
      battlePanel.setItems([
        {
          xtype: 'container',
          html: `<div class="animate-pop-bounce" style="text-align:center; font-size: 20px; margin-bottom: 20px; color: white;">🎉 <b>You Won!</b></div>`
        },
        {
          xtype: 'container',
          layout: {
